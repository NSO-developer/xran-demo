...
1. [nso-setup.md](https://github.com/mark-grayson/xrandemo/blob/master/nso-setup.md) describes how to install, and setup NSO, build the Network Element Driver for xRAN's RU, start a simulated RU and load its configuration and operational data.

2. [restconfexample.md](https://github.com/mark-grayson/xrandemo/blob/master/restconfexample.md) describes how to use NSO's RESTCONF API to recover the live status from the simulated RU, to use PyangBind to define and update the configuration of the RU and to load the live status of the simulated RU into a Python class hierarchy.
